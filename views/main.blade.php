...
<head>
  ...
  <link href="{{asset('resto/assets/vendor/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">
  <link href="{{asset('resto/assets/vendor/bootstrap-icons/bootstrap-icons.css')}}" rel="stylesheet">
  <link href="{{asset('resto/assets/vendor/boxicons/css/boxicons.min.css')}}" rel="stylesheet">
  <link href="{{asset('resto/assets/vendor/glightbox/css/glightbox.min.css')}}" rel="stylesheet">
  <link href="{{asset('resto/assets/vendor/swiper/swiper-bundle.min.css')}}" rel="stylesheet">

  <!-- Template Main CSS File -->
  <link href="{{asset('resto/assets/css/style.css')}}" rel="stylesheet">
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-cente">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <h1 class="logo me-auto me-lg-0"><a href="index.html">Dapur Mama</a></h1>
      <!-- Uncomment below if you prefer to use an image logo -->
      <!-- <a href="index.html" class="logo me-auto me-lg-0"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>-->

      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="nav-link scrollto" href="#why-us">Resep</a></li>
...
<br><br><br>
 ...
 <p>
    100 g taoge;
    100 g kacang panjang, iris;
    75 g kol, iris;
    1 ikat daun kemangi, petik;
    2 buah terung lalap, iris;
...
Menuang Bango Kecap Manis Light dalam bumbu.
...
3. Masukkan semua sayuran. Aduk hingga rata dan hidangkan di piring saji.
    ...
    <h3>Cara membuat</h3>
    1. Panaskan 1 sdm minyak, masak oncom sambil diaduk hingga aroma langunya berkurang. nasi tutug oncom tumis bumbu
2. Panaskan sisa minyak, tumis bumbu halus hingga harum. Masukkan oncom, Royco Kaldu Jamur, Bango Kecap Manis Light, merica, dan terasi. Masak hingga matang dan tumisan mengering.
nasi tutug oncom dan nasi
3. Tambahkan nasi putih, aduk hingga rata. Angkat. Bagi menjadi 4 bagian. Sisihkan. nasi tutug oncom daun pisang
4. Siapkan daun pisang, olesi dengan minyak. Sisihkan. nasi tutug oncom bungkus daun
5. Taruh nasi ke atas daun pisang. Bungkus. Sematkan dengan tusuk gigi. nasi tutug oncom produk
6. Sajikan nasi tutug oncom dengan pelengkap.
...
<h3>Cara membuat</h3>
Kuah: 
1. Giling semua bahan bumbu hingga halus benar.
...
Penyajian:
Susun mie kuning, tauge, dan siram kaldu berikut bakso, kikil dan tetelan.
...
8. Angkat dan taburi bawang merah goreng.
          ...
          <div class="col-lg-4 mt-4 mt-lg-0">
            <div class="box" data-aos="zoom-in" data-aos-delay="300">
              ...
              <h4>Ayam Bakakak</h4>
              <h3>Bahan</h3>
              1 ekor ayam kampung, belah bagian tengah tidak putus;
...
<div class="container-fluid" data-aos="fade-up" data-aos-delay="100">
  ...
  <div class="row g-0">
    ...
    <div class="col-lg-3 col-md-4">
      <div class="gallery-item">
        <a href="{{asset('resto/assets/img/gallery/karedok.jpeg')}}" class="gallery-lightbox" data-gall="gallery-item">
          <img src="{{asset('resto/assets/img/gallery/karedok.jpeg')}}" alt="" class="img-fluid">
        </a>
      </div>
    </div>
    ...
    <div class="col-lg-3 col-md-4">
      <div class="gallery-item">
        <a href="{{asset('resto/assets/img/gallery/oncom.jpeg')}}" class="gallery-lightbox" data-gall="gallery-item">
          <img src="{{asset('resto/assets/img/gallery/oncom.jpeg')}}" alt="" class="img-fluid">
        </a>
      </div>
    </div>
    ...
    <div class="col-lg-3 col-md-4">
      <div class="gallery-item">
        <a href="{{asset('resto/assets/img/gallery/gentong.jpeg')}}" class="gallery-lightbox" data-gall="gallery-item">
          <img src="{{asset('resto/assets/img/gallery/gentong.jpeg')}}" alt="" class="img-fluid">
        </a>
      </div>
    </div>
    ...
    <div class="col-lg-3 col-md-4">
      <div class="gallery-item">
        <a href="{{asset('resto/assets/img/gallery/mikocok.jpeg')}}" class="gallery-lightbox" data-gall="gallery-item">
          <img src="{{asset('resto/assets/img/gallery/mikocok.jpeg')}}" alt="" class="img-fluid">
        </a>
      </div>
    </div>
    ...
    <div class="col-lg-3 col-md-4">
      <div class="gallery-item">
        <a href="{{asset('resto/assets/img/gallery/gepuk.jpeg')}}" class="gallery-lightbox" data-gall="gallery-item">
          <img src="{{asset('resto/assets/img/gallery/gepuk.jpeg')}}" alt="" class="img-fluid">
        </a>
      </div>
    </div>
    ...
    <div class="col-lg-3 col-md-4">
      <div class="gallery-item">
        <a href="{{asset('resto/assets/img/gallery/bakakak.jpeg')}}" class="gallery-lightbox" data-gall="gallery-item">
          <img src="{{asset('resto/assets/img/gallery/bakakak.jpeg')}}" alt="" class="img-fluid">
        </a>
      </div>
    </div>
  ...
  <script src="{{asset('resto/assets/js/main.js')}}"></script>
